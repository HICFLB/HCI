...
<head>
    ...
    <script charset="UTF-8" language="javascript" type="text/javascript" src="/resources/js/Manager/examine.js"></script>
    ...
    <div class="wrap_pane">
        <div class="filter clear">
            ...
            <div class="filter_all">
                <a id="all" href="#"  onclick="choiceType(this)" class="active">全部</a>
                <span class="line">|</span>
            </div>
            <div class="filter-con">
                <a id="no_check" href="#" onclick="choiceType(this)" >尚未审核</a>
                <span class="line">|</span>
                <a id="check_pass" href="#" onclick="choiceType(this)">审核通过</a>
                <span class="line">|</span>
                <a id="check_refuse" href="#" onclick="choiceType(this)">拒绝申请</a>
            </div>
